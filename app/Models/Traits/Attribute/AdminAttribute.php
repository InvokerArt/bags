...
trait AdminAttribute
{
    ...
    {
        return '<a href="' . route(env('APP_BACKEND_PREFIX').'.access.user.destroy', $this->id) . '" data-method="destroy" class="btn btn-xs red"><i class="fa fa-trash" data-toggle="tooltip" data-placement="top" title="删除"></i></a>';
    }
    ...
    public function getAdminDeleteButtonAttribute()
    {
        //创始人不能编辑
        if ($this->id>1) {
            return '<a href="' . route(env('APP_BACKEND_PREFIX').'.access.admin.destroy', $this->id) . '" data-method="destroy" class="btn btn-xs red"><i class="fa fa-trash" data-toggle="tooltip" data-placement="top" title="删除"></i></a>';
        }
