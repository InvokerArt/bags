        ...
        <div class="uploader">
            ...
            <div class="tabbable upload-tabbable"> <!-- Only required for left/right tabs -->
                <ul class="nav nav-tabs">
                    ...
                    <?php if ($java_upload) { ?>
                        <li><a href="#tab2" id="uploader-btn" data-toggle="tab"><?php echo trans('Upload_java'); ?></a>
                        </li>
                    <?php } ?>
                </ul>
        ...
        <div class="row-fluid ff-container">
            <div class="span12">
                ...
                <ul class="grid cs-style-2 <?php echo "list-view" . $view; ?>" id="main-item-container">
                    ...
                    foreach ($files as $file_array) {
                        ...
                        <li data-name="<?php echo $file ?>"
                            ...
                            <?php } else { ?>
                                ...
                                <div
                                    class="file-date"><?php echo date(trans('Date_type'), $file_array['date']); ?></div>
                    ...
                    if (!$ftp) {
                        $file_path = $storage_path . $rfm_subfolder . $subdir . $file;
                            ...
                            <a href="javascript:void('')" class="link" data-file="<?php echo $file; ?>"
                               data-function="<?php echo $apply; ?>">
                                ...
                                <div class="img-precontainer-mini <?php if ($is_img) echo 'original-thumb' ?>">
                                    <div
                                        class="filetype <?php echo $file_array['extension'] ?> <?php if (in_array($file_array['extension'], $editable_text_file_exts)) echo 'edit-text-file-allowed' ?> <?php if (!$is_icon_thumb) {
                                            echo "hide";
                            ...
                            <figcaption>
                                <form action="force_download.php" method="post" class="download-form"
                                    ...
                                    <?php } elseif ($viewerjs_enabled && in_array($file_array['extension'], $viewerjs_file_exts)) { ?>
                                        <a class="tip-right file-preview-btn" title="<?php echo trans('Preview') ?>"
                                           data-url="ajax_calls.php?action=get_file&sub_action=preview&preview_mode=viewerjs&title=<?php echo $filename; ?>&file=<?php echo $rfm_subfolder . $subdir . $file; ?>"
                                           href="docs.google.com;"><i class=" icon-eye-open"></i></a>
