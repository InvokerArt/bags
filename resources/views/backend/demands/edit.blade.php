...
@section('content')
{{ Form::model($demand, ['route' => [env('APP_BACKEND_PREFIX').'.demands.update', $demand], 'class' => 'form-horizontal', 'method' => 'PATCH', 'id' => 'edit-demand']) }}
    <div class="portlet">            
        <div class="portlet-title">
            <div class="actions btn-set">
                <button type="button" name="back" class="btn btn-secondary-outline" onclick="location.href='{{ route(env('APP_BACKEND_PREFIX').'.demands.index') }}'">
