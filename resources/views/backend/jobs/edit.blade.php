        ...
        <div class="left-body-content">
            <div class="exhibition-body">
                <div class="form-group">
                    {{ Form::text('title', null, ['class' => 'form-control', 'placeholder' => '在此输入招聘标题']) }}
                </div>
                {{-- <div class="inside">
                ...
                <div class="form-group margin-top-15">
                    {{ Form::textarea('subtitle', null, ['class' => 'form-control', 'placeholder' => '在此输入招聘简介', 'rows' => '3']) }}
        ...
        <div class="right-sidebar">
            ...
            <div class="box margin-bottom-15">
                ...
                <div class="inside">
                    ...
                    {{ Form::text('address', null, ['class' => 'form-control', 'placeholder' => '招聘地址']) }}
                </div>
            </div>
            <div class="box margin-bottom-15">
                <h2>
            ...
            <div class="box margin-bottom-15">
                ...
                <div class="inside">
                    {{ Form::hidden('image', null, ['class' => 'thumbnail', 'v-model' => 'image']) }}
                    ...
                    <p class="help-block" v-if="image">
                        <a href="javascript:;" class="exhibition-thumbnail" @click="removeImage()">移除特色图片</a>
                    </p>
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        new Vue({
            ...
            ready: function () {
                //移除图片
                // $(document).on('click', '.exhibition-thumbnail', function(){
                //     $('.thumbnail').val('');
                // })
            },
