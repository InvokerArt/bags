        ...
        $(function() {
            ...
            grid.init({
                ...
                dataTable: {
                    ...
                    columns: [
                        {data: 'ids', name: 'news.ids',"orderable": false,"searchable": false},
                        {data: 'id', name: 'news.id',"orderable": true,"searchable": true},
                        {data: 'title', name: 'news.title',"orderable": true,"searchable": true},
                        {data: 'author', name: 'news.user_id',"orderable": false,"searchable": true},
                        {data: 'categories', name: 'categories.name',"orderable": false,"searchable": true},
                        {data: 'tags', name: 'tags.name',"orderable": false,"searchable": true},
                        {data: 'comments_count', name: 'comments_count',"orderable": true,"searchable": false},
                        {data: 'published_at', name: 'news.published_at',"orderable": true,"searchable": true},
