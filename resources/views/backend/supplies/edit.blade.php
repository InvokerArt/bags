...
@section('content')
{{ Form::model($supply, ['route' => [env('APP_BACKEND_PREFIX').'.supplies.update', $supply], 'class' => 'form-horizontal', 'method' => 'PATCH', 'id' => 'edit-supply']) }}
    <div class="portlet">            
                    ...
                    <div class="tab-pane active" id="tab1">
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    {{ Form::select('user_id', [$supply->user_id => $supply->username], $supply->user_id, ['class' => 'form-control', 'readonly' => true]) }}
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label">
                                    ...
                                    <div class="form-control height-auto">
                                        ...
                                        <div class="row">
                                            <div id="licenses_uploader_filelist" class="col-md-12">
                                                @foreach ($supply->images as $key => $image)
