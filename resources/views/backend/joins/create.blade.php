...
@section('content')
{{ Form::open(['route' => env('APP_BACKEND_PREFIX').'.joins.store', 'class' => 'form-horizontal', 'method' => 'post', 'id' => 'submit_form']) }}
    <div class="portlet">            
                    ...
                    <div class="tab-pane active" id="tab1">
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    {{ Form::text('companyname', null, ['class' => 'form-control', 'autocomplete' => 'off', 'id' => 'companyname']) }}
