...
@section('content')
{{ Form::model($join, ['route' => [env('APP_BACKEND_PREFIX').'.joins.update', $join], 'class' => 'form-horizontal', 'method' => 'PATCH', 'id' => 'edit-join']) }}
    <div class="portlet">            
        <div class="portlet-title">
            <div class="actions btn-set">
                <button type="button" name="back" class="btn btn-secondary-outline" onclick="location.href='{{ route(env('APP_BACKEND_PREFIX').'.joins.index') }}'">
                    ...
                    <div class="tab-pane active" id="tab1">
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    {{ Form::select('user_id', [$join->user_id => $join->username], $join->user_id, ['class' => 'form-control', 'readonly' => true]) }}
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label">
                                ...
                                <div class="col-md-10">
                                    {{ Form::select('company_id', [$join->company_id => $join->companyname], $join->company_id, ['class' => 'form-control', 'readonly' => true]) }}
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label">
                                    ...
                                    <div class="form-control height-auto">
                                        ...
                                        <div class="row">
                                            <div id="photos_uploader_filelist" class="col-md-12">
                                                @foreach ($join->identity_card as $key => $identity_card)
                                    ...
                                    <div class="form-control height-auto">
                                        ...
                                        <div class="row">
                                            <div id="licenses_uploader_filelist" class="col-md-12">
                                                @foreach ($join->licenses as $key => $license)
                                                <div class="alert added-files alert-success" id="uploaded_file_{{ $key }}" style="margin:12px 0 0;">
