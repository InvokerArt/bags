...
<div id="crop-avatar">
    {{ Form::open(['route' => env('APP_BACKEND_PREFIX').'.users.store', 'class' => 'form-horizontal', 'method' => 'post', 'id' => 'create-user']) }}
        <div class="portlet" id="crop-avatar">
            <div class="note note-danger no-margin margin-bottom-10">点击头像进行上传，上传成功后一定要保存头像信息。</div>
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <span class="help-block">密码长度必须大于6位</span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label">
    ...
    <div class="modal fade" id="avatar-modal" aria-hidden="true" aria-labelledby="avatar-modal-label" role="dialog" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                {!! Form::open(['route' => [env('APP_BACKEND_PREFIX').'.users.avatar'], 'class' => 'avatar-form', 'method' => 'POST']) !!}
