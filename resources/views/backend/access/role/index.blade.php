...
<div class="portlet light portlet-fit portlet-datatable bordered">
    <div class="portlet-title">
        <div class="actions">
            <a href="{{ route(env('APP_BACKEND_PREFIX').'.access.role.create') }}" class="btn green btn-info">
        ...
        $(function() {
            ...
            grid.init({
                ...
                dataTable: {
                    ...
                    autoWidth: false,
                    ajax: {
                        url: '{{ route(env('APP_BACKEND_PREFIX').".access.role.get") }}',
                    },
                    columns: [
                        {data: 'name', name: '',"orderable": true,"searchable": true},
                        {data: 'display_name', name: '',"orderable": false,"searchable": false},
                        {data: 'permissions', name: '',"orderable": false,"searchable": false},
                        {data: 'description', name: '',"orderable": true,"searchable": true},
                        {data: 'users', name: '',"orderable": true,"searchable": true},
                        {data: 'sort', name: '',"orderable": true,"searchable": false},
            ...
            $('body').on('submit', 'form[name=delete_item]', function(e){
                ...
                var text = (link.attr('data-trans-text')) ? link.attr('data-trans-text') : "你确定要删除这个角色吗？";
