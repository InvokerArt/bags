 ...
 * Generated for Laravel 5.3.21 on 2016-10-27.
 *
...
namespace {
    ...
    class Auth extends \Illuminate\Support\Facades\Auth{
         ...
         * @param mixed $id
         * @param bool $remember
         * @return \App\Models\Access\User\User|false 
         * @static 
         */
    ...
    class SmsManager extends \Toplan\Sms\Facades\SmsManager{
         ...
         * @static 
         */
        public static function vsprintf($template, $data, $onError = null){
            return \Toplan\Sms\SmsManager::vsprintf($template, $data, $onError);
        }
         ...
         * @static 
         */
        public static function pathOfUrl($url, $onError = null){
            return \Toplan\Sms\SmsManager::pathOfUrl($url, $onError);
        }
